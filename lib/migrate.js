...
async function migrate() {
  ...
  try {
    ...
    await client.query(`
      ALTER TABLE ledger ADD COLUMN IF NOT EXISTS visible_to_user BOOLEAN NOT NULL DEFAULT true;
    `);

    await client.query(`
      ALTER TABLE ledger ADD COLUMN IF NOT EXISTS conversion_group TEXT;
    `);
